...
module.exports = {
    ...
    SESSION: process.env.AKINA_CODE === undefined ? '' : process.env.AKINA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALMSG: process.env.ALIVE_MG === undefined ? 'default' : process.env.ALIVE_MG,
    GRPLINK: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/JoURrKEZutWGMMqAadmM8e' : process.env.GROUP_LINK,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/c0f8c2c5be86619be6efe.jpg' : process.env.LG_LOGO,
    ...
    NBOT: process.env.BOT_NM === undefined ? 'Akina' : process.env.BOT_NM,
